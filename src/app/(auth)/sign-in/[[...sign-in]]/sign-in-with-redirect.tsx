    ...
    <SignIn
      appearance={{
        elements: {
          ...
          // Form styling
          formButtonPrimary:
            'bg-green-600 hover:bg-green-700 focus:ring-green-500 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 text-sm',
          formFieldInput:
            'block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-3 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-green-500 focus:ring-green-500 text-sm',
          formFieldLabel:
          ...
          // Links styling
          footerActionLink:
            'text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 font-medium text-sm',
